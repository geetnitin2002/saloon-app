...
import SalonLogo1 from "TARGET_BUILD/images/uploads/logo11.png";
    ...
    return (
      <>
        ...
        <section className="create-listing">
          <LoginWrapper>
          <div className="wrapper" style={nameStyle}>
            <h3>Reviewer View</h3>

            <ButtonWraspper>
            <Link to={() => this.redirectLink("/all-business-list")}>
                <a
                  href={void 0}
              ...
              <ButtonWraspper>
              <Link to={() => this.redirectLink("/edited-business-list")}>
                <a
                  href={void 0}
                  onClick={this.servicesLoad}
                  className="abtn"
